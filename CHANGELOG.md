...
Prior published release on npm (`@signalsafe/tree-spec-editor`). Detailed historical notes were not recorded in this repository.

[Unreleased]: https://github.com/SignalSafeSoftware/tree-spec-editor/compare/v0.2.2...HEAD
